...
const PasswordField: React.FC<Props> = ({ label, touched, error, field, inputProps, pattern, ref, ...rest }) => {
  ...
  return (
    <Form.Item
      ...
      {...rest}
    >
      <Input.Password {...field} {...inputProps} style={{ fontSize: 'inherit' }} onChange={onChange} ref={ref} />
    </Form.Item>
  );
};
